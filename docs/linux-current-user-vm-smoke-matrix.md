...
S1 through S7 require a concrete Linux runner/helper. Until that runner exists,
transcripts must mark those rows as skipped with the reason `runner not wired`;
they must not be counted as smoke passes.
