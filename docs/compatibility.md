...
| Antigravity | TLA+ / TLC | 15.x (Sequoia-era docs) | native containment | **works with caveats** | [docs/harnesses.md](harnesses.md), [docs/integrations.md](integrations.md), [recipe](recipes/gemini-tla.md) | Requires the Java/TLA runtime path to be available and usually needs a more manual auth/runtime setup than Claude. |
