...
func compileDarwinSBPLChecked(policy nativeSessionPolicy) (string, error) {
	...
	if policy.MacOSSecurityFramework {
	...
	if policy.MacOSSecurityFramework || policy.MacOSAgentKeychainAccess {
