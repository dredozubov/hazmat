...
**2026-06-12 Amp/Devin/Kilo/Kimi/Kiro/Goose credential-state expansion:** Host
credential hardening now includes Amp config/plugin roots, Devin
config/auth-adjacent state, Kilo/Kimi/Kiro config/credential/session roots, and
...
**2026-06-12 Amp/Devin/Kilo/Kimi/Kiro/Goose credential-state expansion:** The credential
...
legacy `~/.kimi`, `~/.kiro`, `~/.config/goose`, `~/.local/share/goose`, and
`~/.local/state/goose`. `agentCliStateDir` is the representative finite-model
leaf for Kilo/Kimi/Kiro-style external agent CLI state roots so the proof does
not grow one dimension per vendor.
...
**2026-06-12 Amp/Devin/Kilo/Kimi/Kiro/Goose credential-state expansion:** The abstract
...
config, Kilo/Kimi/Kiro config/session roots, and Goose config/session/log deny
roots.
...
**2026-06-12 Amp/Devin/Kilo/Kimi/Kiro/Goose credential-state expansion:** The equivalence
...
Devin, Kilo/Kimi/Kiro, and Goose credential-state roots consistently.
...
**2026-06-12 Amp/Devin/Kilo/Kimi/Kiro/Goose credential-state expansion:** The Apple
...
Amp config, Devin config, Kilo/Kimi/Kiro config/session roots, and Goose
