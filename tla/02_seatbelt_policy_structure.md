...
Fourteen abstract paths with a containment relation:
...
agent-owned session temp root remains usable for compiler/runtime artifacts,
...
|-----------|-------|-----------|
| Paths | 14 | Covers: normal project, agent home, credential dirs, config overlap, outside ref, invoker resume dir, host temp, session temp, Claude runtime temp, and Codex temp socket paths |
...
**Confirmed state space:** 6,336 states generated, 5,760 distinct. Runtime: ~6s.
